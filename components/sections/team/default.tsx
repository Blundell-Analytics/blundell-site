    ...
    <section id="team" className="bg-ink relative z-10">
      <div className="rail rule-t rule-b py-14 lg:py-16">
        ...
        <p className="text-fg-3 mt-6 max-w-xl text-base leading-relaxed">
          Blundell Analytics is deliberately small. The people who build the
          work are the people who present it, so nothing is lost between the
          analysis and the room it gets argued in.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3">
        {PEOPLE.map((person, i) => (
          ...
          >
            <div className="bg-well relative aspect-square w-full overflow-hidden">
              <img
                src={person.photo}
                alt={person.name}
                loading="lazy"
            ...
            <div className="rail py-10 lg:py-12">
